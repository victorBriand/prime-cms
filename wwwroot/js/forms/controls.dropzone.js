    ...
    if (document.querySelector('#dropzoneServerFiles')) {
      new Dropzone('#dropzoneServerFiles', {
        ...
        init: function () {
          ...
          let mockFile1 = {name: 'cupcake.webp', size: 12842};
          this.displayExistingFile(mockFile1, Helpers.UrlFix('/img/product/small/product-9.webp'));

          // Setting extra type parameter to show icon instead of thumbnail. It still needs to have a image for some reason.
          let mockFile2 = {name: 'bread.webp', size: 22354};
          ...
          // this.displayExistingFile(mockFile, "https://i.picsum.photos/id/959/120/120.webp", callback, crossOrigin, resizeThumbnail);
