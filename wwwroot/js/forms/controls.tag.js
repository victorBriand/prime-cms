        ...
        whitelist: [
          {
            ...
            avatar: Helpers.UrlFix('/img/profile/profile-1.webp'),
            email: 'jhattersley0@ucsd.edu',
          },
          {
            value: 2,
            name: 'Antons Esson',
            avatar: Helpers.UrlFix('/img/profile/profile-2.webp'),
            email: 'aesson1@ning.com',
          },
          {
            value: 3,
            name: 'Ardeen Batisse',
            avatar: Helpers.UrlFix('/img/profile/profile-3.webp'),
            email: 'abatisse2@nih.gov',
          },
          {
            value: 4,
            name: 'Graeme Yellowley',
            avatar: Helpers.UrlFix('/img/profile/profile-4.webp'),
            email: 'gyellowley3@behance.net',
          },
          {
            value: 5,
            name: 'Dido Wilford',
            avatar: Helpers.UrlFix('/img/profile/profile-5.webp'),
            email: 'dwilford4@jugem.jp',
          },
          {
            value: 6,
            name: 'Celesta Orwin',
            avatar: Helpers.UrlFix('/img/profile/profile-6.webp'),
            email: 'corwin5@meetup.com',
          },
          {
            value: 7,
            name: 'Sally Main',
            avatar: Helpers.UrlFix('/img/profile/profile-7.webp'),
            email: 'smain6@techcrunch.com',
          },
          {
            value: 8,
            name: 'Grethel Haysman',
            avatar: Helpers.UrlFix('/img/profile/profile-8.webp'),
